    ...
    <div class="site-section">
        ...
        <div class="container">
            ...
            <div class="row no-gutters align-items-stretch h-100">
                ...
                <div class="col-lg-6">
                    <div class="row no-gutters align-items-stretch h-100 half-sm">
                        <div class="col-md-6 bg-image order-md-1 order-lg-2 bg-sm-height" style="background-image: url('/images/img_3_colored.jpg');" data-aos="fade" data-aos-delay="300"></div>
